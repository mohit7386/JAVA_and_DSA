...
/*the "current object reference" means the object that was originally created using new Test() is being used again.
✔️ getInstance() is just returning that same object, and we are storing it in Obj.
