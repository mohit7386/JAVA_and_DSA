...
//WAP to sort the list of elemets on the basis of marks using comparator
import java.util.*;
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(students, new Comparator<Student>() {
            public int compare(Student a, Student b) {
                return a.marks - b.marks; // this logic will print the students on the basis of marks in ascending order
            }
        });
