...
public class Strings_1 {
    public static void main(String[] args) {
        ...
        // first name jaise hi blank space ayega ye print nhi krega so hum iski jagah
        ...
        String Name2 = new String("Mohit Pratap Singh"); // here we are creating the object of the new string
